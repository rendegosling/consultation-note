...
export class ConsultationService {
  ...
  async createConsultation(request: CreateConsultationRequest): Promise<ConsultationSession> {
    try {
  ...
  async updateStatus(id: string, status: ConsultationSession['status']): Promise<void> {
    try {
